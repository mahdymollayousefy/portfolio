...
export default function Legal() {
 ...
 <h1 className="text-lg md:text-3xl lg:text-4xl font-black text-slate-800 dark:text-slate-100 mb-10 text-center tracking-tight">
 {t('legal_title')}
 </h1>
 ...
 <h2 className="text-base md:text-lg md:text-2xl font-bold text-slate-800 dark:text-slate-200">{t('privacy_title')}</h2>
 </div>
 ...
 <h2 className="text-base md:text-lg md:text-2xl font-bold text-slate-800 dark:text-slate-200">{t('cookie_title')}</h2>
 </div>
 ...
 <h2 className="text-base md:text-lg md:text-2xl font-bold text-slate-800 dark:text-slate-200">{t('rules_title')}</h2>
 </div>
 ...
 <h2 className="text-base md:text-lg md:text-2xl font-bold text-slate-800 dark:text-slate-200">{t('payment_title')}</h2>
 </div>
